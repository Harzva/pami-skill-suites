# Data Mining Expansion Pack

This opt-in expansion pack groups Elsevier journal coverage for the **data mining** area.
...
- `eval_tasks/data-mining_coverage_task.yaml`
- `paper_card_todo.md`
- `promotion_queue.md`
