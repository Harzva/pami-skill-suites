# Signal Processing Expansion Pack

This opt-in expansion pack groups Elsevier journal coverage for the **signal processing** area.
...
- `eval_tasks/signal-processing_coverage_task.yaml`
- `paper_card_todo.md`
- `promotion_queue.md`
