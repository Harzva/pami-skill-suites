# Remote Sensing Expansion Pack

This opt-in expansion pack groups Elsevier journal coverage for the **remote sensing** area.
...
- `eval_tasks/remote-sensing_coverage_task.yaml`
- `paper_card_todo.md`
- `promotion_queue.md`
