...
v2.7.0 is the current validated release for the Elsevier skill suite. The release preserves the compact default skill layer and keeps advanced skills, expansion packs, presets, and main-figure assets opt-in.
