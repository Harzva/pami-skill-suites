...
Context-safe AI-agent skill-suite for Elsevier journal manuscripts.

This repository is **unofficial** and is not affiliated with Elsevier. It does not provide legal advice and does not replace the latest official instructions from the publisher, target journal, society owner, or submission system.
