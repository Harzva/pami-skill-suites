---
name: elsevier-journal-router
description: "Elsevier Journal Router: detect target journals and route to the correct independent journal adapter while preserving publisher-family boundaries and official URL checks. Use for Elsevier AI, computer vision, pattern recognition, expert systems, information science, and medical AI journals."
family: elsevier
version: 0.5.0
kind: router
...
Common journal adapters include: applied-soft-computing-writing, artificial-intelligence-medicine-writing, artificial-intelligence-writing, biomedical-signal-processing-control-writing, cmpb-writing, computer-speech-language-writing, computers-biology-medicine-writing, cviu-writing, data-knowledge-engineering-writing, decision-support-systems-writing, eaai-writing, eswa-writing.
