---
name: elsevier-submission-router
description: "Elsevier Submission Router: route submission workflows such as cover letter, author agreement, copyright/license, open access, revision response, final files, proof correction, and official-source checks. Use for Elsevier AI, computer vision, pattern recognition, expert systems, information science, and medical AI journals."
family: elsevier
version: 0.5.0
kind: router
...
Common submission routes include: cover-letter → `elsevier-cover-letter`, response → `elsevier-response`, submission-package → `elsevier-submission-package`, author-agreement → `elsevier-author-agreement`, preprint-prior-publication → `elsevier-preprint-prior-publication`, declarations → `elsevier-declarations`, proof-correction → `elsevier-proof-correction`.
