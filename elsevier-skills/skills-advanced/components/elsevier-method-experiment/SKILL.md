---
name: elsevier-method-experiment
description: "Elsevier Method + Experiments: method exposition, experimental settings, baseline fairness, statistics, and reproducibility."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Method + Experiments Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **method exposition, experimental settings, baseline fairness, statistics, and reproducibility**.
...
Produce submission-ready academic assistance for **Elsevier Method + Experiments** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: insufficient settings, missing statistical evidence, weak baseline descriptions.
