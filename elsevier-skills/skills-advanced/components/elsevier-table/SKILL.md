---
name: elsevier-table
description: "Elsevier Table: submission-ready tables, editable table text, caption logic, notes, abbreviations, and non-duplicative presentation."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Table Skill

## When to use this skill

Use this skill when the user needs help with **submission-ready tables, editable table text, caption logic, notes, abbreviations, and non-duplicative presentation** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Table** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier table** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
