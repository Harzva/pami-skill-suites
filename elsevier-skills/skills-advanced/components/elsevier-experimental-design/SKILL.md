---
name: elsevier-experimental-design
description: "Elsevier Experimental Design: experiment plan, validation logic, dataset split, protocol, controls, and fairness of comparisons."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Experimental Design Skill

## When to use this skill

Use this skill when the user needs help with **experiment plan, validation logic, dataset split, protocol, controls, and fairness of comparisons** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Experimental Design** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier experimental design** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
