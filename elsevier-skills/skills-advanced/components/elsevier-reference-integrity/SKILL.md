---
name: elsevier-reference-integrity
description: "Elsevier Reference Integrity: reference completeness, citation order, related-work coverage, and anti-fabrication checks."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Reference Integrity Skill

## When to use this skill

Use this skill when the user needs help with **reference completeness, citation order, related-work coverage, and anti-fabrication checks** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Reference Integrity** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier reference integrity** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
