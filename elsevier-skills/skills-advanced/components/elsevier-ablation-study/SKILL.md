---
name: elsevier-ablation-study
description: "Elsevier Ablation Study: ablation design, component-level evidence, sensitivity analysis, and mechanism validation."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Ablation Study Skill

## When to use this skill

Use this skill when the user needs help with **ablation design, component-level evidence, sensitivity analysis, and mechanism validation** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Ablation Study** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier ablation study** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
