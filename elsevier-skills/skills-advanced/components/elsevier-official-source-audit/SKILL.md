---
name: elsevier-official-source-audit
description: "Elsevier Official Source Audit: mapping workflow rules to Elsevier Guide for Authors, target journal instructions, LaTeX/source-package guidance, Highlights, Graphical Abstract, declarations, and GenAI policy checkpoints before making submission-readiness claims."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Official Source Audit Skill
...
Official source map; target journal guide; manuscript text; Highlights; graphical abstract plan; declarations; source package; figures/tables; references; revision package.
