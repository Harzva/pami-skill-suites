---
name: elsevier-statistical-significance
description: "Elsevier Statistical Significance: statistical tests, confidence intervals, robustness, multi-run reporting, and effect-size interpretation."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Statistical Significance Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **statistical tests, confidence intervals, robustness, multi-run reporting, and effect-size interpretation**.
...
Produce submission-ready academic assistance for **Elsevier Statistical Significance** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: single-run claims, unsupported superiority, p-value misuse.
