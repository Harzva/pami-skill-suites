---
name: elsevier-graphical-abstract-brief
description: "Elsevier Graphical Abstract Brief: Elsevier graphical abstract brief, visual message, permissions, file requirements, and GenAI artwork restrictions."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Graphical Abstract Brief Skill

## When to use this skill

Use this skill when the user needs help with **Elsevier graphical abstract brief, visual message, permissions, file requirements, and GenAI artwork restrictions** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Graphical Abstract Brief** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
- Preferred style: clear, technical, evidence-led, submission-package aware.
...
- Official source hierarchy: first verify the current Elsevier Guide for Authors, ScienceDirect journal page, Editorial Manager, Elsevier LaTeX instructions, policies, Highlights, Graphical Abstract, and publishing agreement pages. If official instructions differ from this skill, official instructions win.
...
Title page; Abstract; Keywords; Highlights; Graphical Abstract when requested; Introduction; Methods; Results; Discussion; Declarations; References; Supplementary files.

This skill focuses on the **elsevier graphical abstract brief** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
