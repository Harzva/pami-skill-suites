---
name: elsevier-checklist-risk-register
description: "Elsevier Checklist Risk Register: pre-submission checklist, reviewer-risk register, desk-rejection risk, and issue prioritization."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Checklist Risk Register Skill

## When to use this skill

Use this skill when the user needs help with **pre-submission checklist, reviewer-risk register, desk-rejection risk, and issue prioritization** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Checklist Risk Register** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier checklist risk register** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
