---
name: elsevier-template-paper-miner
description: "Elsevier Template Paper Miner: using the bundled CC-BY/open-access Elsevier template corpus to extract structural patterns without copying scientific content."
family: elsevier
version: 0.5.0
kind: core
...
Mine Elsevier open-access template papers for article architecture, Highlights logic, application framing, evidence layout, figure/table function, and reviewer-risk lessons while preventing content copying.
...
- Desired output assets: revised text, skill routing plan, source map, claim-evidence map, risk register, Highlights, Keywords, graphical abstract plan, declarations, data availability notes, cover letter, and submission package checklist.

## Style profile

- Preferred style: Elsevier technical-journal style: concise but complete, evidence-first, clear application or method value, package-aware, and sensitive to Highlights/declarations requirements.
...
Template paper; structural outline; abstract/highlights plan; method/experiment skeleton; figures/tables; discussion/limitations; declarations; response or revision plan.
...
5. Treat Elsevier Guide for Authors, target journal Guide for Authors, elsarticle/LaTeX instructions, Highlights and Graphical Abstract guidance, and Elsevier journal policies as verification targets, not decorative references.
...
- Official-source claims are tied to Elsevier Guide for Authors, target journal Guide for Authors, elsarticle/LaTeX instructions, Highlights and Graphical Abstract guidance, and Elsevier journal policies or are marked for verification.
