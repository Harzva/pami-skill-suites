---
name: elsevier-abstract-keywords
description: "Elsevier Abstract + Keywords: abstract, keywords, contribution compression, and discoverability for Elsevier submissions."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Abstract + Keywords Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **abstract, keywords, contribution compression, and discoverability for Elsevier submissions**.
...
Produce submission-ready academic assistance for **Elsevier Abstract + Keywords** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: vague abstract, mismatched keywords, overclaimed conclusions.
