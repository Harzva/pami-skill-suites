---
name: elsevier-latex-template-audit
description: "Elsevier LaTeX Template Audit: elsarticle-style source package, references, highlights, graphical abstract, and submission files."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier LaTeX Template Audit Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **elsarticle-style source package, references, highlights, graphical abstract, and submission files**.
...
Produce submission-ready academic assistance for **Elsevier LaTeX Template Audit** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: wrong journal style, missing separate source files, broken figure/table refs.
