---
name: elsevier-graphical-abstract-file
description: "Elsevier Graphical Abstract File: separate graphical abstract file planning, size/readability checks, permissions, and upload package integration."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Graphical Abstract File Skill

## When to use this skill

Use this skill when the user needs help with **separate graphical abstract file planning, size/readability checks, permissions, and upload package integration** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Graphical Abstract File** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
