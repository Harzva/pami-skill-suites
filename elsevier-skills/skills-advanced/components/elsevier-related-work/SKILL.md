---
name: elsevier-related-work
description: "Elsevier Related Work: related work taxonomy, prior-art contrast, citation positioning, and novelty boundaries."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Related Work Skill

## When to use this skill

Use this skill when the user needs help with **related work taxonomy, prior-art contrast, citation positioning, and novelty boundaries** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Related Work** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier related work** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
