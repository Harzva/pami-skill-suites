---
name: biomedical-signal-processing-control-writing
description: "Biomedical Signal Processing and Control: biomedical signal analysis, control, sensors, physiological signals, and clinical engineering validation."
family: elsevier
version: 0.5.0
...
Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **biomedical signal analysis, control, sensors, physiological signals, and clinical engineering validation**.
