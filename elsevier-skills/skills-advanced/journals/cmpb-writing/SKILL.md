---
name: cmpb-writing
description: "Computer Methods and Programs in Biomedicine: biomedical software, methods, computational systems, validation, and reproducible implementations."
family: elsevier
version: 0.5.0
...
Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **biomedical software, methods, computational systems, validation, and reproducible implementations**.
