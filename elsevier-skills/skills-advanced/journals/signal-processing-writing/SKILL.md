---
name: signal-processing-writing
description: "Signal Processing: signal processing theory, algorithms, audio/image/biomedical signals, filtering, estimation, and learning-based signal models."
family: elsevier
version: 0.5.0
...
Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **signal processing theory, algorithms, audio/image/biomedical signals, filtering, estimation, and learning-based signal models**.
