---
name: computers-biology-medicine-writing
description: "Computers in Biology and Medicine: computational methods for biology, medicine, diagnostics, biomedical data, and translational validation."
family: elsevier
version: 0.5.0
...
Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **computational methods for biology, medicine, diagnostics, biomedical data, and translational validation**.
