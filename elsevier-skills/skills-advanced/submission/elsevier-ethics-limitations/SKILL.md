---
name: elsevier-ethics-limitations
description: "Elsevier Ethics + Limitations: ethics, limitations, dataset bias, deployment caveats, medical/biological/social risk checks."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Ethics + Limitations Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **ethics, limitations, dataset bias, deployment caveats, medical/biological/social risk checks**.
...
Produce submission-ready academic assistance for **Elsevier Ethics + Limitations** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: boilerplate limitations, missing privacy/bias discussion, unsupported deployment claims.
