---
name: elsevier-open-access-decision
description: "Elsevier Open Access Decision: open access route, funder mandate, license implications, APC reminder, and institutional agreement check."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Open Access Decision Skill

## When to use this skill

Use this skill when the user needs help with **open access route, funder mandate, license implications, APC reminder, and institutional agreement check** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Open Access Decision** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier open access decision** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
