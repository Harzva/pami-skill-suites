---
name: elsevier-author-agreement
description: "Elsevier Author Agreement: publishing agreement readiness, author rights reminders, copyright form/license route, and post-acceptance decisions."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Author Agreement Skill

## When to use this skill

Use this skill when the user needs help with **publishing agreement readiness, author rights reminders, copyright form/license route, and post-acceptance decisions** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Author Agreement** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier author agreement** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
