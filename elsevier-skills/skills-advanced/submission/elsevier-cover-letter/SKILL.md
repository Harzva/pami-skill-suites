---
name: elsevier-cover-letter
description: "Elsevier Cover Letter: submission cover letter for Elsevier journals."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Cover Letter Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **submission cover letter for Elsevier journals**.
...
Produce submission-ready academic assistance for **Elsevier Cover Letter** while preserving the user's actual scientific claims and separating evidence from speculation.
