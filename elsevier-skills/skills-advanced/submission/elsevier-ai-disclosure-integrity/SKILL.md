---
name: elsevier-ai-disclosure-integrity
description: "Elsevier AI Disclosure + Integrity: AI-assisted writing transparency, originality, citation integrity, and author-responsibility reminders."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier AI Disclosure + Integrity Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **AI-assisted writing transparency, originality, citation integrity, and author-responsibility reminders**.
...
Produce submission-ready academic assistance for **Elsevier AI Disclosure + Integrity** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: fabricated citations, hidden generated evidence, authorship ambiguity.
