---
name: elsevier-revision-diff
description: "Elsevier Revision Diff: revision plan, manuscript change log, response evidence, and clean/marked manuscript coordination."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Revision Diff Skill

## When to use this skill

Use this skill when the user needs help with **revision plan, manuscript change log, response evidence, and clean/marked manuscript coordination** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Revision Diff** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier revision diff** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
