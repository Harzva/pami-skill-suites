---
name: elsevier-theory-proof
description: "Elsevier Theory Proof: theoretical analysis, propositions, assumptions, proof sketches, and mathematical rigor."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Theory Proof Skill

## When to use this skill

Use this skill when the user needs help with **theoretical analysis, propositions, assumptions, proof sketches, and mathematical rigor** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Theory Proof** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier theory proof** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
