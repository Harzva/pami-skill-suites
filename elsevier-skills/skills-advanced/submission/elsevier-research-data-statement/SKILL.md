---
name: elsevier-research-data-statement
description: "Elsevier Research Data Statement: Elsevier research data statement, data linking, repository choice, and data availability wording."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Research Data Statement Skill

## When to use this skill

Use this skill when the user needs help with **Elsevier research data statement, data linking, repository choice, and data availability wording** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Research Data Statement** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier research data statement** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
