---
name: elsevier-revision-strategy
description: "Elsevier Revision Strategy: reviewer response strategy, experiment triage, revised manuscript change plan, and cover letter update."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Revision Strategy Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **reviewer response strategy, experiment triage, revised manuscript change plan, and cover letter update**.
...
Produce submission-ready academic assistance for **Elsevier Revision Strategy** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: defensive tone, untracked changes, unsupported rebuttal.
