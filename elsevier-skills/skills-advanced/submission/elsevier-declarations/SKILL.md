---
name: elsevier-declarations
description: "Elsevier Declarations: declarations, ethics prompts, competing interests, funding, author contributions, and acknowledgements checklist."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Declarations Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **declarations, ethics prompts, competing interests, funding, author contributions, and acknowledgements checklist**.
...
Produce submission-ready academic assistance for **Elsevier Declarations** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: missing required declarations, invented compliance statements, author-responsibility gaps.
