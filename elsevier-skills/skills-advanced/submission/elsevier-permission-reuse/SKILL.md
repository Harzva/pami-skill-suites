---
name: elsevier-permission-reuse
description: "Elsevier Permission Reuse: permissions for reused figures/tables/text, third-party material, CC license checks, and attribution wording."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Permission Reuse Skill

## When to use this skill

Use this skill when the user needs help with **permissions for reused figures/tables/text, third-party material, CC license checks, and attribution wording** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Permission Reuse** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier permission reuse** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
