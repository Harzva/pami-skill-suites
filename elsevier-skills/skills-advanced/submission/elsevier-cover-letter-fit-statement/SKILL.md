---
name: elsevier-cover-letter-fit-statement
description: "Elsevier Cover Letter Fit Statement: cover letter, scope fit statement, novelty framing, prior-publication disclosure, and editor-facing summary."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Cover Letter Fit Statement Skill

## When to use this skill

Use this skill when the user needs help with **cover letter, scope fit statement, novelty framing, prior-publication disclosure, and editor-facing summary** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Cover Letter Fit Statement** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier cover letter fit statement** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
