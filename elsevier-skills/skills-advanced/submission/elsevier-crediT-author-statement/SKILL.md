---
name: elsevier-crediT-author-statement
description: "Elsevier Credit Author Statement: CRediT author roles, contribution disclosure, author accountability, and submission package alignment."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Credit Author Statement Skill

## When to use this skill

Use this skill when the user needs help with **CRediT author roles, contribution disclosure, author accountability, and submission package alignment** for a Elsevier journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **Elsevier Credit Author Statement** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **elsevier credit author statement** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
