---
name: elsevier-data-availability
description: "Elsevier Data Availability: data/code availability statement, repository hygiene, reproducibility assets, and restrictions."
family: elsevier
version: 0.5.0
kind: core
...
# Elsevier Data Availability Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **Elsevier journals** work related to **data/code availability statement, repository hygiene, reproducibility assets, and restrictions**.
...
Produce submission-ready academic assistance for **Elsevier Data Availability** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: promised data unavailable, unclear access conditions, missing versioning.
