...
This directory provides the lawful, source-recorded template-paper corpus for `elsevier-skills`.
...
- Open-access research papers: 6
- Official template/manual PDFs: 1
