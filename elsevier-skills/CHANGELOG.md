...
## v1.5.0 - Preset Evaluation Harness + User Scenario Gallery

- Added preset scenario galleries, sample outputs, route traces, and evaluation reports.
- Added preset scenario validation and evaluation scripts.
- Added preset route trace and coverage explainability scripts.
- Preserved context-safe compact architecture.

## v1.5.0 - Discipline-Specific Preset Routers
...
- Added source-refresh metadata to 25 journal fragments.
...
This project is unofficial and is not affiliated with Elsevier. Mutable publishing details require live verification before real submission.
...
- Reduced default-visible skills to 9 macro skills.
...
- Added suite-level router skill `elsevier-skill-suite`.
- Added component router `elsevier-component-router` and submission router `elsevier-submission-router`.
- Upgraded journal router `elsevier-journal-router`.
