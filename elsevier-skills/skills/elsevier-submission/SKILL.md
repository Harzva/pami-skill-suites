---
name: elsevier-submission
description: "Prepare Elsevier submission-package checklists, cover letters, declarations, rights/license checks, and final-file reminders with live verification warnings."
family: elsevier
version: 1.2.0
kind: macro
...
Use this skill for submission packages, cover letters, author agreements, declarations, OA/license checks, and final files. If the request mentions a specific journal, manuscript component, or submission/legal item, pair this macro skill with `elsevier-skill-suite` routing rather than loading every advanced skill.
