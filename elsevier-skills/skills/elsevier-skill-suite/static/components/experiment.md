...
Help users draft, rewrite, audit, or strengthen the experiment part of a Elsevier manuscript without loading every component skill into the default context.

## When to use

Use when the user asks about experiment, manuscript structure, evidence quality, or reviewer-risk reduction for this component.
