...
source_skill: elsevier-experimental-design
version: 0.8.0
status: context-safe-fragment
---

# Elsevier Experimental Design Module
...
This component should consult `resources/experiment_organization_library.json` and `paper_templates/mining_notes/` for reusable organization routines. These routines are structural best practices and visual/paper-mining observations; they do not override publisher or journal official rules.
