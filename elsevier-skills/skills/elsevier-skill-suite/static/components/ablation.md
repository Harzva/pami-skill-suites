...
Help users draft, rewrite, audit, or strengthen the ablation part of a Elsevier manuscript without loading every component skill into the default context.

## When to use

Use when the user asks about ablation, manuscript structure, evidence quality, or reviewer-risk reduction for this component.
