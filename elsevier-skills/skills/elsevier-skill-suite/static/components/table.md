---
module: table
source_skill: elsevier-table
version: 0.8.0
status: context-safe-fragment
---

# Elsevier Table Module
...
This component should consult `resources/table_pattern_library.json` and `paper_templates/mining_notes/` for reusable organization routines. These routines are structural best practices and visual/paper-mining observations; they do not override publisher or journal official rules.
