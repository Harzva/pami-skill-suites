...
# Code Availability Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Purpose

Handle the code availability part of a Elsevier manuscript workflow while keeping legal, publication, and policy claims source-grounded.

## When to use

Use when the user asks about code availability, submission assets, revision materials, author declarations, rights, licenses, or final files.
