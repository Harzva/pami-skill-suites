...
Handle the conflict of interest part of a Elsevier manuscript workflow while keeping legal, publication, and policy claims source-grounded.

## When to use

Use when the user asks about conflict of interest, submission assets, revision materials, author declarations, rights, licenses, or final files.
