---
module: response-letter
source_skill: generated-canonical-submission
version: 0.8.0
status: context-safe-fragment
---

# Response Letter Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Purpose

Handle the response letter part of a Elsevier manuscript workflow while keeping legal, publication, and policy claims source-grounded.

## When to use

Use when the user asks about response letter, submission assets, revision materials, author declarations, rights, licenses, or final files.
