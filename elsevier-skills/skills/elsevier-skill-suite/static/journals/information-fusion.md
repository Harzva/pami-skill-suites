---
module: information-fusion
source_skill: information-fusion-writing
version: 0.8.0
status: context-safe-fragment
---

# Information Fusion Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: Information Fusion
- Common abbreviation: Information Fusion
- Publisher: Elsevier
- Field: sensor fusion, multimodal fusion, data fusion theory and applications
...
- short: Information Fusion
- publisher: Elsevier
- issn: 1566-2535
- homepage: https://www.sciencedirect.com/journal/information-fusion
- elsevier_journal_page: https://www.elsevier.com/journals/information-fusion/1566-2535
- guide_for_authors: https://www.sciencedirect.com/journal/information-fusion/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/information-fusion/publish/guide-for-authors#submit-your-article
- scope: sensor fusion, multimodal fusion, data fusion theory and applications
...
- Typical reviewer risk: fusion mechanism not justified, missing modality ablations, weak uncertainty analysis.
...
Produce submission-ready academic assistance for **Information Fusion** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- information fusion skill
- information-fusion
- information-fusion-writing
...
This fragment was generated from `information-fusion-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/information-fusion | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/information-fusion/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/information-fusion/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Information Fusion**.
