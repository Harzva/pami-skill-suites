---
module: signal-processing-image-communication
source_skill: signal-processing-image-communication-writing
version: 0.8.0
status: context-safe-fragment
---

# Signal Processing: Image Communication Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: Signal Processing: Image Communication
- Common abbreviation: Signal Processing: Image Communication
- Publisher: Elsevier
- Field: image communication, visual signal processing, coding, streaming and representation
...
- short: Signal Processing: Image Communication
- publisher: Elsevier
- issn: 0923-5965
- homepage: https://www.sciencedirect.com/journal/signal-processing-image-communication
- elsevier_journal_page: https://www.elsevier.com/journals/signal-processing-image-communication/0923-5965
- guide_for_authors: https://www.sciencedirect.com/journal/signal-processing-image-communication/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/signal-processing-image-communication/publish/guide-for-authors#submit-your-article
- scope: image communication, visual signal processing, coding, streaming and representation
...
- Typical reviewer risk: missing bitrate/quality tradeoffs, weak codec/system comparisons.
...
Produce submission-ready academic assistance for **Signal Processing: Image Communication** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- signal processing: image communication skill
- signal-processing-image-communication
- signal-processing-image-communication-writing
...
This fragment was generated from `signal-processing-image-communication-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/signal-processing-image-communication | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/signal-processing-image-communication/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/signal-processing-image-communication/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Signal Processing: Image Communication**.
...
- Expansion pack membership: multimedia, signal-processing
