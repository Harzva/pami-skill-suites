---
module: jvcir
source_skill: jvcir-writing
version: 0.8.0
status: context-safe-fragment
---

# Journal of Visual Communication and Image Representation Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: Journal of Visual Communication and Image Representation
- Common abbreviation: Journal of Visual Communication and Image Representation
- Publisher: Elsevier
- Field: visual communication, image representation, multimedia, compression and analysis
...
- short: Journal of Visual Communication and Image Representation
- publisher: Elsevier
- issn: 1047-3203
- homepage: https://www.sciencedirect.com/journal/journal-of-visual-communication-and-image-representation
- elsevier_journal_page: https://www.elsevier.com/journals/journal-of-visual-communication-and-image-representation/1047-3203
- guide_for_authors: https://www.sciencedirect.com/journal/journal-of-visual-communication-and-image-representation/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/journal-of-visual-communication-and-image-representation/publish/guide-for-authors#submit-your-article
- scope: visual communication, image representation, multimedia, compression and analysis
...
- Typical reviewer risk: insufficient representation/coding framing, weak media-specific baselines.
...
Produce submission-ready academic assistance for **Journal of Visual Communication and Image Representation** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- journal of visual communication and image representation skill
- jvcir
- jvcir-writing
...
This fragment was generated from `jvcir-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/journal-of-visual-communication-and-image-representation | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/journal-of-visual-communication-and-image-representation/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/journal-of-visual-communication-and-image-representation/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Journal of Visual Communication and Image Representation**.
...
- Expansion pack membership: multimedia
