---
module: medical-image-analysis
source_skill: medical-image-analysis-writing
version: 0.8.0
status: context-safe-fragment
---

# Medical Image Analysis Journal Module
...
- Common abbreviation: Medical Image Analysis
- Publisher: Elsevier
- Field: medical image analysis, computational imaging, biomedical AI, segmentation, registration, diagnosis
...
- short: Medical Image Analysis
- publisher: Elsevier
- issn: 1361-8415
- homepage: https://www.sciencedirect.com/journal/medical-image-analysis
- elsevier_journal_page: https://www.elsevier.com/journals/medical-image-analysis/1361-8415
- guide_for_authors: https://www.sciencedirect.com/journal/medical-image-analysis/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/medical-image-analysis/publish/guide-for-authors#submit-your-article
- scope: medical image analysis, computational imaging, biomedical AI, segmentation, registration, diagnosis
...
Produce submission-ready academic assistance for **Medical Image Analysis** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- medical-image-analysis
- medical-image-analysis-writing
...
This fragment was generated from `medical-image-analysis-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/medical-image-analysis | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/medical-image-analysis/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/medical-image-analysis/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Medical Image Analysis**.
...
- Expansion pack membership: computer-vision, medical-ai
