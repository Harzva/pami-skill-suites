---
module: robotics-autonomous-systems
source_skill: robotics-autonomous-systems-writing
version: 0.8.0
status: context-safe-fragment
---

# Robotics and Autonomous Systems Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: Robotics and Autonomous Systems
- Common abbreviation: Robotics and Autonomous Systems
- Publisher: Elsevier
- Field: robotics, autonomous systems, control, perception, planning and applications
...
- short: Robotics and Autonomous Systems
- publisher: Elsevier
- issn: 0921-8890
- homepage: https://www.sciencedirect.com/journal/robotics-and-autonomous-systems
- elsevier_journal_page: https://www.elsevier.com/journals/robotics-and-autonomous-systems/0921-8890
- guide_for_authors: https://www.sciencedirect.com/journal/robotics-and-autonomous-systems/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/robotics-and-autonomous-systems/publish/guide-for-authors#submit-your-article
- scope: robotics, autonomous systems, control, perception, planning and applications
...
- Typical reviewer risk: simulation-only evidence, unsafe autonomy claims, weak real-world validation.
...
Produce submission-ready academic assistance for **Robotics and Autonomous Systems** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- robotics and autonomous systems skill
- robotics-autonomous-systems
- robotics-autonomous-systems-writing
...
This fragment was generated from `robotics-autonomous-systems-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/robotics-and-autonomous-systems | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/robotics-and-autonomous-systems/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/robotics-and-autonomous-systems/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Robotics and Autonomous Systems**.
