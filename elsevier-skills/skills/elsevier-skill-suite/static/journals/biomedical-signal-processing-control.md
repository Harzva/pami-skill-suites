---
module: biomedical-signal-processing-control
source_skill: biomedical-signal-processing-control-writing
version: 0.8.0
status: context-safe-fragment
---

# Biomedical Signal Processing and Control Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: Biomedical Signal Processing and Control
- Common abbreviation: Biomedical Signal Processing and Control
- Publisher: Elsevier
- Field: biomedical signals, medical signal processing, control, clinical engineering
...
- short: Biomedical Signal Processing and Control
- publisher: Elsevier
- issn: 1746-8094
- homepage: https://www.sciencedirect.com/journal/biomedical-signal-processing-and-control
- elsevier_journal_page: https://www.elsevier.com/journals/biomedical-signal-processing-and-control/1746-8094
- guide_for_authors: https://www.sciencedirect.com/journal/biomedical-signal-processing-and-control/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/biomedical-signal-processing-and-control/publish/guide-for-authors#submit-your-article
- scope: biomedical signals, medical signal processing, control, clinical engineering
...
- Typical reviewer risk: signal preprocessing underspecified, missing patient-level evaluation, weak control/biomedical relevance.
...
Produce submission-ready academic assistance for **Biomedical Signal Processing and Control** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- biomedical signal processing and control skill
- biomedical-signal-processing-control
- biomedical-signal-processing-control-writing
...
This fragment was generated from `biomedical-signal-processing-control-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/biomedical-signal-processing-and-control | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/biomedical-signal-processing-and-control/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/biomedical-signal-processing-and-control/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Biomedical Signal Processing and Control**.
...
- Expansion pack membership: medical-ai, signal-processing
