...
source_skill: artificial-intelligence-writing
version: 0.8.0
status: context-safe-fragment
---

# Artificial Intelligence Journal Module
...
- Common abbreviation: Artificial Intelligence
- Publisher: Elsevier
- Field: AI theory, search, reasoning, planning, learning, agents, foundations
...
- elsevier_journal_page: https://www.elsevier.com/journals/artificial-intelligence/0004-3702
- guide_for_authors: https://www.sciencedirect.com/journal/artificial-intelligence/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/artificial-intelligence/publish/guide-for-authors#submit-your-article
- scope: AI theory, search, reasoning, planning, learning, agents, foundations
...
Produce submission-ready academic assistance for **Artificial Intelligence** while preserving the user's actual scientific claims and separating evidence from speculation.
...
This fragment was generated from `artificial-intelligence-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/artificial-intelligence | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/artificial-intelligence/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/artificial-intelligence/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Artificial Intelligence**.
