---
module: data-knowledge-engineering
source_skill: data-knowledge-engineering-writing
version: 0.8.0
status: context-safe-fragment
---

# Data & Knowledge Engineering Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: Data & Knowledge Engineering
- Common abbreviation: Data & Knowledge Engineering
- Publisher: Elsevier
- Field: data engineering, knowledge engineering, database systems, semantic data management
...
- short: Data & Knowledge Engineering
- publisher: Elsevier
- issn: 0169-023X
- homepage: https://www.sciencedirect.com/journal/data-and-knowledge-engineering
- elsevier_journal_page: https://www.elsevier.com/journals/data-and-knowledge-engineering/0169-023X
- guide_for_authors: https://www.sciencedirect.com/journal/data-and-knowledge-engineering/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/data-and-knowledge-engineering/publish/guide-for-authors#submit-your-article
- scope: data engineering, knowledge engineering, database systems, semantic data management
...
- Typical reviewer risk: knowledge/data contribution unclear, missing system evaluation.
...
Produce submission-ready academic assistance for **Data & Knowledge Engineering** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- data & knowledge engineering skill
- data-knowledge-engineering
- data-knowledge-engineering-writing
...
This fragment was generated from `data-knowledge-engineering-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/data-and-knowledge-engineering | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/data-and-knowledge-engineering/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/data-and-knowledge-engineering/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Data & Knowledge Engineering**.
