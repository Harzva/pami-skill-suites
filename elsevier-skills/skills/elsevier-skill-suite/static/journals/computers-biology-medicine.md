---
module: computers-biology-medicine
source_skill: computers-biology-medicine-writing
version: 0.8.0
status: context-safe-fragment
---

# Computers in Biology and Medicine Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: Computers in Biology and Medicine
- Common abbreviation: Computers in Biology and Medicine
- Publisher: Elsevier
- Field: computational biology, medical computing, biomedical AI, clinical data systems
...
- short: Computers in Biology and Medicine
- publisher: Elsevier
- issn: 0010-4825
- homepage: https://www.sciencedirect.com/journal/computers-in-biology-and-medicine
- elsevier_journal_page: https://www.elsevier.com/journals/computers-in-biology-and-medicine/0010-4825
- guide_for_authors: https://www.sciencedirect.com/journal/computers-in-biology-and-medicine/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/computers-in-biology-and-medicine/publish/guide-for-authors#submit-your-article
- scope: computational biology, medical computing, biomedical AI, clinical data systems
...
- Typical reviewer risk: clinical claims overreaching, missing cohort details, weak biological interpretation.
...
Produce submission-ready academic assistance for **Computers in Biology and Medicine** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- computers in biology and medicine skill
- computers-biology-medicine
- computers-biology-medicine-writing
...
This fragment was generated from `computers-biology-medicine-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/computers-in-biology-and-medicine | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/computers-in-biology-and-medicine/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/computers-in-biology-and-medicine/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Computers in Biology and Medicine**.
