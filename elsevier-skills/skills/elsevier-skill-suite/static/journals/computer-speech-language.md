---
module: computer-speech-language
source_skill: computer-speech-language-writing
version: 0.8.0
status: context-safe-fragment
---

# Computer Speech & Language Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: Computer Speech & Language
- Common abbreviation: Computer Speech & Language
- Publisher: Elsevier
- Field: speech processing, spoken language processing, natural language and audio systems
...
- short: Computer Speech & Language
- publisher: Elsevier
- issn: 0885-2308
- homepage: https://www.sciencedirect.com/journal/computer-speech-and-language
- elsevier_journal_page: https://www.elsevier.com/journals/computer-speech-and-language/0885-2308
- guide_for_authors: https://www.sciencedirect.com/journal/computer-speech-and-language/publish/guide-for-authors
- submit_article: https://www.sciencedirect.com/journal/computer-speech-and-language/publish/guide-for-authors#submit-your-article
- scope: speech processing, spoken language processing, natural language and audio systems
...
- Typical reviewer risk: missing linguistic analysis, weak dataset coverage, shallow error analysis.
...
Produce submission-ready academic assistance for **Computer Speech & Language** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- computer speech & language skill
- computer-speech-language
- computer-speech-language-writing
...
This fragment was generated from `computer-speech-language-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.sciencedirect.com/journal/computer-speech-and-language | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.sciencedirect.com/journal/computer-speech-and-language/publish/guide-for-authors | journal official rule | Live verification required before submission |
| Submission system | https://www.sciencedirect.com/journal/computer-speech-and-language/publish/guide-for-authors#submit-your-article | publisher official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **Computer Speech & Language**.
