---
name: elsevier-reviewer
description: "Simulate Elsevier journal reviewers and identify novelty, evidence, experiment, formatting, and integrity risks with compact module routing."
family: elsevier
version: 1.2.0
kind: macro
...
Use this skill for review simulation, reviewer-risk diagnosis, and editorial-screening preparation. If the request mentions a specific journal, manuscript component, or submission/legal item, pair this macro skill with `elsevier-skill-suite` routing rather than loading every advanced skill.
