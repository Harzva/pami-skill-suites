---
name: elsevier-response
description: "Prepare Elsevier reviewer-response letters, revision matrices, rebuttal plans, and change summaries with source-grounded compliance checks."
family: elsevier
version: 1.2.0
kind: macro
...
Use this skill for reviewer response letters, revision matrices, rebuttal framing, and change summaries. If the request mentions a specific journal, manuscript component, or submission/legal item, pair this macro skill with `elsevier-skill-suite` routing rather than loading every advanced skill.
