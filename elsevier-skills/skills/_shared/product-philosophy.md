...
`elsevier-skills` is built as a product-style skill repository, not a single prompt collection.
...
Elsevier journal-family manuscripts require different outputs and reviewer-risk controls. A high-quality skill repo should encode those differences into checklists, output contracts, and official-source verification steps rather than relying on memory or generic academic-writing prompts.
