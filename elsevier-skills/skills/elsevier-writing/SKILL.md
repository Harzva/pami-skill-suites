---
name: elsevier-writing
description: "Draft, rewrite, and audit Elsevier journal manuscripts via compact suite fragments for journals, components, evidence, structure, and official-source checks."
family: elsevier
version: 1.2.0
kind: macro
...
Use this skill for full manuscript drafting, rewriting, structure, and claim-evidence improvement. If the request mentions a specific journal, manuscript component, or submission/legal item, pair this macro skill with `elsevier-skill-suite` routing rather than loading every advanced skill.
