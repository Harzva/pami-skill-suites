---
name: elsevier-citation
description: "Audit Elsevier citations, reference integrity, missing related work, and bibliography consistency without fabricating sources."
family: elsevier
version: 1.2.0
kind: macro
...
Use this skill for citation integrity, reference consistency, missing prior work, and bibliography-risk checks. If the request mentions a specific journal, manuscript component, or submission/legal item, pair this macro skill with `elsevier-skill-suite` routing rather than loading every advanced skill.
