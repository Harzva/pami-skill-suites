---
name: ieee-polishing
description: "IEEE Polishing: technical English polishing for IEEE-style manuscripts."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Polishing Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **technical English polishing for IEEE-style manuscripts**.
...
Produce submission-ready academic assistance for **IEEE Polishing** while preserving the user's actual scientific claims and separating evidence from speculation.
