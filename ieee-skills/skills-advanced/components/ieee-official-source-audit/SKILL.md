---
name: ieee-official-source-audit
description: "IEEE Official Source Audit: mapping workflow rules to IEEE Author Center, target-publication instructions, templates, style manuals, and policy checkpoints before making submission-readiness claims."
family: ieee
version: 0.5.0
kind: core
...
Audit every IEEE workflow claim against official sources, separate stable style guidance from unstable journal-specific requirements, and produce a verifiable submission-readiness checklist.
...
Official source map; target-journal instructions; manuscript text; template/source package; figures/tables; references; declarations; response or revision package.
