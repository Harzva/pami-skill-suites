---
name: ieee-experiment-ablation
description: "IEEE Experiments + Ablation: experimental design, baseline fairness, ablations, robustness, and failure analysis."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Experiments + Ablation Skill
...
- Typical reviewer risk: missing ablations, cherry-picked metrics, unfair baselines, no sensitivity analysis.
