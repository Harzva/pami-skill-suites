---
name: ieee-multimedia-supplement
description: "IEEE Multimedia Supplement: videos, code demos, multimedia items, file captions, and supplementary upload package."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Multimedia Supplement Skill

## When to use this skill

Use this skill when the user needs help with **videos, code demos, multimedia items, file captions, and supplementary upload package** for a IEEE journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **IEEE Multimedia Supplement** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **ieee multimedia supplement** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
