---
name: ieee-title-author-metadata
description: "IEEE Title Author Metadata: title, author metadata, affiliations, corresponding author details, and front-matter integrity."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Title Author Metadata Skill

## When to use this skill

Use this skill when the user needs help with **title, author metadata, affiliations, corresponding author details, and front-matter integrity** for a IEEE journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **IEEE Title Author Metadata** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **ieee title author metadata** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
