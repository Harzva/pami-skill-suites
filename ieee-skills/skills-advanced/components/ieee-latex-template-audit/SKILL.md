---
name: ieee-latex-template-audit
description: "IEEE LaTeX Template Audit: IEEE template-readiness, source package hygiene, equations, captions, and references."
family: ieee
version: 0.5.0
kind: core
...
# IEEE LaTeX Template Audit Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **IEEE template-readiness, source package hygiene, equations, captions, and references**.
...
Produce submission-ready academic assistance for **IEEE LaTeX Template Audit** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: template drift, nonstandard formatting, broken cross-references, unverified author instructions.
