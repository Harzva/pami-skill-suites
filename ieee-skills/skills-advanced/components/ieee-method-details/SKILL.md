---
name: ieee-method-details
description: "IEEE Method Details: method section completeness, implementation clarity, architectural motivation, and reproducibility details."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Method Details Skill

## When to use this skill

Use this skill when the user needs help with **method section completeness, implementation clarity, architectural motivation, and reproducibility details** for a IEEE journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **IEEE Method Details** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **ieee method details** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
