---
name: ieee-reproducibility-check
description: "IEEE Reproducibility Check: pre-submission reproducibility and evidence audit."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Reproducibility Check Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **pre-submission reproducibility and evidence audit**.
...
Produce submission-ready academic assistance for **IEEE Reproducibility Check** while preserving the user's actual scientific claims and separating evidence from speculation.
