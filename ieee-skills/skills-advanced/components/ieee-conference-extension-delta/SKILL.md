---
name: ieee-conference-extension-delta
description: "IEEE Conference Extension Delta: conference-to-journal extension gap, overlap disclosure, new material, and contribution delta."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Conference Extension Delta Skill

## When to use this skill

Use this skill when the user needs help with **conference-to-journal extension gap, overlap disclosure, new material, and contribution delta** for a IEEE journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **IEEE Conference Extension Delta** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
