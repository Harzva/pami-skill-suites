---
name: ieee-appendix
description: "IEEE Appendix: appendices, extended derivations, extra tables, and material that should not interrupt the main paper."
family: ieee
version: 0.5.0
kind: core
...
Use this skill when the user needs help with **appendices, extended derivations, extra tables, and material that should not interrupt the main paper** for a IEEE journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **IEEE Appendix** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **ieee appendix** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
