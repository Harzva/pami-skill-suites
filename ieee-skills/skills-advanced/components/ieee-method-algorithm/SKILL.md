---
name: ieee-method-algorithm
description: "IEEE Method + Algorithm: method exposition, notation, algorithms, architecture, and implementation clarity."
family: ieee
version: 0.5.0
kind: core
...
- Typical reviewer risk: undefined variables, ambiguous algorithm steps, untraceable design choices.
