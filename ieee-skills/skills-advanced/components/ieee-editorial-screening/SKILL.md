---
name: ieee-editorial-screening
description: "IEEE Editorial Screening: desk-rejection risk, scope fit, novelty, formatting, ethics, and completeness audit."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Editorial Screening Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **desk-rejection risk, scope fit, novelty, formatting, ethics, and completeness audit**.
...
Produce submission-ready academic assistance for **IEEE Editorial Screening** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: wrong venue, incremental contribution, missing author declarations, weak significance.
