---
name: ieee-journal-router
description: "Ieee Journal Router: detect target journals and route to the correct independent journal adapter while preserving publisher-family boundaries and official URL checks. Use for IEEE Transactions, Journals, Letters, and IEEE-style technical journal writing."
family: ieee
version: 0.5.0
kind: router
...
## Journal-layer routing behavior

Use this router when the target journal is named or implied. It should map aliases to independent journal adapter skills and preserve publisher boundaries.

Common journal adapters include: ieee-access-writing, intelligent-transportation-systems-writing, jbhi-writing, pami-writing, tac-writing, tai-writing, tase-writing, tcomm-writing, tcsvt-writing, tcyb-writing, tgrs-writing, tifs-writing.

When the user says only "PR", confirm or infer from context that this means Pattern Recognition in Elsevier contexts; do not treat PR as an IEEE journal. When the user says PAMI or TPAMI, route to the IEEE PAMI adapter.
