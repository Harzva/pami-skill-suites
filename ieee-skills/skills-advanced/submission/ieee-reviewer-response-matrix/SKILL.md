---
name: ieee-reviewer-response-matrix
description: "IEEE Reviewer Response Matrix: point-by-point response matrix, editor letter alignment, change tracking, and tone control."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Reviewer Response Matrix Skill

## When to use this skill

Use this skill when the user needs help with **point-by-point response matrix, editor letter alignment, change tracking, and tone control** for a IEEE journal manuscript or a journal-style revision package.
...
Produce submission-ready assistance for **IEEE Reviewer Response Matrix** while preserving the user's actual science, separating evidence from interpretation, and preventing fabricated claims, fake citations, fake formatting rules, fake editor policies, or invented compliance statements.
...
This skill focuses on the **ieee reviewer response matrix** layer, but it should always maintain consistency with the full manuscript: abstract claims must match experiments, figure captions must match results, related work must match contributions, and submission statements must match author-controlled facts.
