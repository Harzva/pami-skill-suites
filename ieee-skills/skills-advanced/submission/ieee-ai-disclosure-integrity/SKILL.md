---
name: ieee-ai-disclosure-integrity
description: "IEEE AI Disclosure + Integrity: transparent AI-assisted writing, plagiarism avoidance, citation integrity, and author-responsibility reminders."
family: ieee
version: 0.5.0
kind: core
...
# IEEE AI Disclosure + Integrity Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **transparent AI-assisted writing, plagiarism avoidance, citation integrity, and author-responsibility reminders**.
...
Produce submission-ready academic assistance for **IEEE AI Disclosure + Integrity** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: fabricated citations, hidden AI-generated evidence, unclear author accountability.
