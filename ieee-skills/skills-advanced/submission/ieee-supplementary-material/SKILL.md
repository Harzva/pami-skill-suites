...
description: "IEEE Supplementary Material: supplementary appendix planning, extra experiments, proofs, data sheets, and demo links."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Supplementary Material Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **supplementary appendix planning, extra experiments, proofs, data sheets, and demo links**.
...
Produce submission-ready academic assistance for **IEEE Supplementary Material** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: main paper depends on inaccessible supplement, missing reproducibility details.
