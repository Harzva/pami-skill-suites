---
name: ieee-revision-strategy
description: "IEEE Revision Strategy: major/minor revision planning, experiment triage, response strategy, and change log."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Revision Strategy Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **major/minor revision planning, experiment triage, response strategy, and change log**.
...
Produce submission-ready academic assistance for **IEEE Revision Strategy** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: defensive responses, unprioritized experiments, unsupported rebuttals.
