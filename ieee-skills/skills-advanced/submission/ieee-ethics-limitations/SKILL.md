---
name: ieee-ethics-limitations
description: "IEEE Ethics + Limitations: limitations, responsible AI, dataset bias, human/medical/security risk, and dual-use disclosure prompts."
family: ieee
version: 0.5.0
kind: core
...
# IEEE Ethics + Limitations Skill

## When to use this skill

Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **limitations, responsible AI, dataset bias, human/medical/security risk, and dual-use disclosure prompts**.
...
Produce submission-ready academic assistance for **IEEE Ethics + Limitations** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- Typical reviewer risk: ethics treated as boilerplate, missing dataset bias, overconfident deployment claims.
