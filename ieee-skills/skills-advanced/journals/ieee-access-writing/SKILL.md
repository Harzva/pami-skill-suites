---
name: ieee-access-writing
description: "IEEE Access: multidisciplinary open-access IEEE articles with clear contribution, validation, and broad technical relevance."
family: ieee
version: 0.5.0
...
Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **multidisciplinary open-access IEEE articles with clear contribution, validation, and broad technical relevance**.
