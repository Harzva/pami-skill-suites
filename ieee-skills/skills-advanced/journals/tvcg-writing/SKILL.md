---
name: tvcg-writing
description: "IEEE TVCG: visualization, visual analytics, graphics, VR/AR, human-centered visual computing."
family: ieee
version: 0.5.0
...
Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **visualization, visual analytics, graphics, VR/AR, human-centered visual computing**.
