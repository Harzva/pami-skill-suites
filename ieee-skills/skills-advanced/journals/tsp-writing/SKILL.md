---
name: tsp-writing
description: "IEEE TSP: signal processing theory, algorithms, estimation, detection, optimization."
family: ieee
version: 0.5.0
...
Use this skill when the user is preparing, revising, polishing, auditing, or responding to reviews for **IEEE Transactions / Journals** work related to **signal processing theory, algorithms, estimation, detection, optimization**.
