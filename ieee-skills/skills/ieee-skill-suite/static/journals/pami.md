---
module: pami
source_skill: pami-writing
version: 0.8.0
status: context-safe-fragment
---

# TPAMI / PAMI Journal Module
...
- Common abbreviation: TPAMI / PAMI
- Publisher: IEEE Computer Society
- Field: computer vision, pattern analysis, machine intelligence, recognition, learning, image understanding
...
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=34
- author_instructions: https://www.computer.org/publications/author-resources
- scope: computer vision, pattern analysis, machine intelligence, recognition, learning, image understanding
...
Produce submission-ready academic assistance for **TPAMI / PAMI** while preserving the user's actual scientific claims and separating evidence from speculation.
...
This fragment was generated from `pami-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.computer.org/csdl/journal/tp | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **TPAMI / PAMI**.
