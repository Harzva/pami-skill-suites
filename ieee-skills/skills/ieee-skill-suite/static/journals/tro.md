---
module: tro
source_skill: tro-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE Transactions on Robotics Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: IEEE Transactions on Robotics
- Common abbreviation: T-RO
- Publisher: IEEE Robotics and Automation Society
- Field: robotics theory, perception, control, planning, manipulation, robot learning
...
- short: T-RO
- publisher: IEEE Robotics and Automation Society
- homepage: https://www.ieee-ras.org/publications/t-ro
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=8860
- author_instructions: https://www.ieee-ras.org/publications/t-ro/information-for-authors
- scope: robotics theory, perception, control, planning, manipulation, robot learning
...
- Typical reviewer risk: simulation-only validation, weak hardware evidence, unsafe deployment assumptions.
...
Produce submission-ready academic assistance for **IEEE Transactions on Robotics** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- ieee transactions on robotics skill
- tro
- tro-writing
...
This fragment was generated from `tro-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.ieee-ras.org/publications/tro | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.ieee-ras.org/publications/t-ro/information-for-authors | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE Transactions on Robotics**.
