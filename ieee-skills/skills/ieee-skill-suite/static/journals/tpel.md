---
module: tpel
source_skill: tpel-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE TPEL Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: IEEE Transactions on Power Electronics
- Common abbreviation: TPEL
- Publisher: IEEE Power Electronics Society
- Field: power electronics devices, converters, systems, applications and controls
...
- short: TPEL
- publisher: IEEE Power Electronics Society
- homepage: https://www.ieee-pels.org/publications/ieee-transactions-on-power-electronics/
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=63
- author_instructions: https://www.ieee-pels.org/publications/ieee-transactions-on-power-electronics/for-authors/
- scope: power electronics devices, converters, systems, applications and controls
...
- Typical reviewer risk: simulation-only power claims, missing hardware validation, unsafe operating assumptions.
...
Produce submission-ready academic assistance for **IEEE TPEL** while preserving the user's actual scientific claims and separating evidence from speculation.
...
This fragment was generated from `tpel-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.ieee-pels.org/publications/ieee-transactions-power-electronics | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.ieee-pels.org/publications/ieee-transactions-on-power-electronics/for-authors/ | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE TPEL**.
