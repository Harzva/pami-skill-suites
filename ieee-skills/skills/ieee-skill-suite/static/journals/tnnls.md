---
module: tnnls
source_skill: tnnls-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE TNNLS Journal Module
...
- Common abbreviation: TNNLS
- Publisher: IEEE Computational Intelligence Society
- Field: neural networks, learning systems, computational intelligence theory and applications
...
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=5962385
- author_instructions: https://cis.ieee.org/publications/t-neural-networks-and-learning-systems/tnnls
- scope: neural networks, learning systems, computational intelligence theory and applications
...
- submission_guidelines: https://cis.ieee.org/publications/t-neural-networks-and-learning-systems/tnnls-guidelines-for-paper-submission
...
Produce submission-ready academic assistance for **IEEE TNNLS** while preserving the user's actual scientific claims and separating evidence from speculation.
...
This fragment was generated from `tnnls-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://cis.ieee.org/publications/t-neural-networks-and-learning-systems | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://cis.ieee.org/publications/t-neural-networks-and-learning-systems/tnnls | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE TNNLS**.
