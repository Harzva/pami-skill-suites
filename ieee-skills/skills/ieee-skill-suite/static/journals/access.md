---
module: access
source_skill: ieee-access-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE Access Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: IEEE Access
- Common abbreviation: IEEE Access
- Publisher: IEEE
- Field: multidisciplinary IEEE engineering, computing, applied systems and technology
...
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=6287639
- author_instructions: https://ieeeaccess.ieee.org/authors/submission-guidelines/
- scope: multidisciplinary IEEE engineering, computing, applied systems and technology
...
- Typical reviewer risk: overbroad framing, insufficient technical depth, scope mismatch.
...
Produce submission-ready academic assistance for **IEEE Access** while preserving the user's actual scientific claims and separating evidence from speculation.
...
This fragment was generated from `ieee-access-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://ieeeaccess.ieee.org/ | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://ieeeaccess.ieee.org/authors/submission-guidelines/ | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE Access**.
