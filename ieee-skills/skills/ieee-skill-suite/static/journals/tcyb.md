---
module: tcyb
source_skill: tcyb-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE Transactions on Cybernetics Journal Module
...
- Common abbreviation: TCYB
- Publisher: IEEE Systems, Man, and Cybernetics Society
- Field: cybernetics, machine learning, control, decision systems, computational intelligence
...
- short: TCYB
- publisher: IEEE Systems, Man, and Cybernetics Society
- homepage: https://www.ieeesmc.org/publications/transactions-on-cybernetics/
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=6221036
- author_instructions: https://www.ieeesmc.org/publications/information-for-authors/
- scope: cybernetics, machine learning, control, decision systems, computational intelligence
...
- Typical reviewer risk: scope too close to generic ML, insufficient systems/cybernetics framing.
...
Produce submission-ready academic assistance for **IEEE Transactions on Cybernetics** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- ieee transactions on cybernetics skill
- tcyb
- tcyb-writing
...
This fragment was generated from `tcyb-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://cis.ieee.org/publications/t-cybernetics | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.ieeesmc.org/publications/information-for-authors/ | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE Transactions on Cybernetics**.
