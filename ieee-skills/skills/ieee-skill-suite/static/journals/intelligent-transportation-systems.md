---
module: intelligent-transportation-systems
source_skill: intelligent-transportation-systems-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE Intelligent Transportation Systems Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: IEEE Transactions on Intelligent Transportation Systems
- Common abbreviation: T-ITS
- Publisher: IEEE Intelligent Transportation Systems Society
- Field: intelligent transportation systems, autonomous vehicles, traffic, mobility, sensing and control
...
- short: T-ITS
- publisher: IEEE Intelligent Transportation Systems Society
- homepage: https://ieee-itss.org/pub/t-its
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=6979
- author_instructions: https://ieee-itss.org/pub/t-its/information-for-authors
- scope: intelligent transportation systems, autonomous vehicles, traffic, mobility, sensing and control
...
- Typical reviewer risk: dataset leakage, simulation-to-real gap, safety-critical claims without evidence.
...
Produce submission-ready academic assistance for **IEEE Intelligent Transportation Systems** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- ieee intelligent transportation systems skill
- intelligent-transportation-systems
- intelligent-transportation-systems-writing
...
This fragment was generated from `intelligent-transportation-systems-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://ieee-itss.org/pub/t-its | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://ieee-itss.org/pub/t-its/information-for-authors | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE Intelligent Transportation Systems**.
