---
module: tmi
source_skill: tmi-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE TMI Journal Module
...
- Common abbreviation: TMI
- Publisher: IEEE Engineering in Medicine and Biology Society
- Field: medical imaging methods, imaging science, biomedical imaging algorithms and validation
...
- short: TMI
- publisher: IEEE Engineering in Medicine and Biology Society
- homepage: https://ieeetmi.org/
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=42
- author_instructions: https://ieeetmi.org/authors-instructions/
- scope: medical imaging methods, imaging science, biomedical imaging algorithms and validation
...
- submission_checklist: https://ieeetmi.org/submission-checklist/
...
Produce submission-ready academic assistance for **IEEE TMI** while preserving the user's actual scientific claims and separating evidence from speculation.
...
This fragment was generated from `tmi-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.embs.org/tmi/ | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://ieeetmi.org/authors-instructions/ | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE TMI**.
