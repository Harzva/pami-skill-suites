---
module: tsp
source_skill: tsp-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE TSP Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: IEEE Transactions on Signal Processing
- Common abbreviation: TSP
- Publisher: IEEE Signal Processing Society
- Field: signal processing theory, algorithms, statistical signal processing, optimization
...
- short: TSP
- publisher: IEEE Signal Processing Society
- homepage: https://signalprocessingsociety.org/publications-resources/ieee-transactions-signal-processing
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=78
- author_instructions: https://signalprocessingsociety.org/publications-resources/information-authors
- scope: signal processing theory, algorithms, statistical signal processing, optimization
...
Produce submission-ready academic assistance for **IEEE TSP** while preserving the user's actual scientific claims and separating evidence from speculation.
...
This fragment was generated from `tsp-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://signalprocessingsociety.org/publications-resources/ieee-transactions-signal-processing | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE TSP**.
