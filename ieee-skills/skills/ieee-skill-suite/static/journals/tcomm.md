---
module: tcomm
source_skill: tcomm-writing
version: 0.8.0
status: context-safe-fragment
---

# IEEE Transactions on Communications Journal Module

> This is an internal fragment used by the skill-suite router. It is not a default top-level skill.

## Journal identity

- Full name: IEEE Transactions on Communications
- Common abbreviation: TCOMM
- Publisher: IEEE Communications Society
- Field: communications theory, networks, coding, wireless, optical, and systems
...
- short: TCOMM
- publisher: IEEE Communications Society
- homepage: https://www.comsoc.org/publications/journals/ieee-tcom
- xplore: https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=26
- author_instructions: https://www.comsoc.org/publications/journals/ieee-tcom/paper-submission-guidelines
- scope: communications theory, networks, coding, wireless, optical, and systems
...
- Typical reviewer risk: unfair channel assumptions, missing complexity/latency, incomplete baseline comparisons.
...
Produce submission-ready academic assistance for **IEEE Transactions on Communications** while preserving the user's actual scientific claims and separating evidence from speculation.
...
- ieee transactions on communications skill
- tcomm
- tcomm-writing
...
This fragment was generated from `tcomm-writing` during the v0.8.0 compact architecture migration. The original independent skill remains available under `skills-advanced/`.

## Official Source Compliance Matrix

| Required area | URL or status | Source tier | Verification status |
|---|---|---|---|
| Journal homepage | https://www.comsoc.org/publications/journals/ieee-tcom | journal official rule | Live verification required before submission |
| Author instructions / Guide for Authors | https://www.comsoc.org/publications/journals/ieee-tcom/paper-submission-guidelines | journal official rule | Live verification required before submission |
...
- Journal official rule: journal homepage, scope page, Guide for Authors / Information for Authors, society page, IEEE Xplore or ScienceDirect page, and submission-system instructions for **IEEE Transactions on Communications**.
