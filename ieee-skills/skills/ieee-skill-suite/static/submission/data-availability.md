...
Handle the data availability part of a IEEE manuscript workflow while keeping legal, publication, and policy claims source-grounded.

## When to use

Use when the user asks about data availability, submission assets, revision materials, author declarations, rights, licenses, or final files.
