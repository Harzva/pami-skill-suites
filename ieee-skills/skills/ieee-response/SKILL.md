---
name: ieee-response
description: "Prepare IEEE reviewer-response letters, revision matrices, rebuttal plans, and change summaries with source-grounded compliance checks."
family: ieee
version: 1.2.0
kind: macro
...
Use this skill for reviewer response letters, revision matrices, rebuttal framing, and change summaries. If the request mentions a specific journal, manuscript component, or submission/legal item, pair this macro skill with `ieee-skill-suite` routing rather than loading every advanced skill.
