...
description: "Audit and improve IEEE figures, tables, captions, result reporting, and visual consistency using compact component fragments."
family: ieee
version: 1.2.0
kind: macro
...
Use this skill for figures, tables, captions, visual accessibility, result reporting, and consistency checks. If the request mentions a specific journal, manuscript component, or submission/legal item, pair this macro skill with `ieee-skill-suite` routing rather than loading every advanced skill.
