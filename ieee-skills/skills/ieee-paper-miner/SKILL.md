...
- Open-access papers bundled in this release: 5
- Official template/manual PDFs bundled in this release: 2
...
6. If the user wants submission/legal guidance, route to `ieee-skill-suite` and official-source fragments instead of relying on template papers.
