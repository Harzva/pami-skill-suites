...
description: "Prepare IEEE submission-package checklists, cover letters, declarations, rights/license checks, and final-file reminders with live verification warnings."
family: ieee
version: 1.2.0
kind: macro
...
Use this skill for submission packages, cover letters, author agreements, declarations, OA/license checks, and final files. If the request mentions a specific journal, manuscript component, or submission/legal item, pair this macro skill with `ieee-skill-suite` routing rather than loading every advanced skill.
