...
Use this preset when the user wants a discipline-fluent workflow, for example `Data Mining` manuscript planning, journal fit routing, related-work audit, table/figure/caption upgrade, reviewer response, paper-mining structure extraction, or source-compliance check.
...
|---|---|---:|---:|
| `tkde` | IEEE TKDE | L3 | A |
| `tai` | IEEE Transactions on Artificial Intelligence | L3 | A |
| `access` | IEEE Access | L3 | A |
