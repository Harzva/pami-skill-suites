...
Use this preset when the user wants a discipline-fluent workflow, for example `Remote Sensing` manuscript planning, journal fit routing, related-work audit, table/figure/caption upgrade, reviewer response, paper-mining structure extraction, or source-compliance check.
...
|---|---|---:|---:|
| `tgrs` | IEEE TGRS | L3 | A |
| `geoscience-remote-sensing-letters` | IEEE Geoscience and Remote Sensing Letters | L0 | E |
