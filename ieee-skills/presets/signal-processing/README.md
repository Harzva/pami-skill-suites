# Signal Processing Preset Router
...
Use this preset when the user wants a discipline-fluent workflow, for example `Signal Processing` manuscript planning, journal fit routing, related-work audit, table/figure/caption upgrade, reviewer response, paper-mining structure extraction, or source-compliance check.
...
| `tsp` | IEEE TSP | L3 | A |
| `tip` | IEEE TIP | L4 | A |
| `tcomm` | IEEE Transactions on Communications | L3 | A |
| `twc` | IEEE Transactions on Wireless Communications | L3 | A |
| `signal-processing-letters` | IEEE Signal Processing Letters | L0 | E |
