...
Use this preset when the user wants a discipline-fluent workflow, for example `Multimedia` manuscript planning, journal fit routing, related-work audit, table/figure/caption upgrade, reviewer response, paper-mining structure extraction, or source-compliance check.
