# Plugin Packaging — IEEE Skills v1.2.0

This directory contains plugin metadata templates for installing IEEE Skills as an agent skill package.
...
- `compact`: one `ieee-skill-suite` router skill, recommended for the smallest listing.
