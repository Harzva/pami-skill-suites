...
required=['presets','resources/preset_eval_report.json','resources/preset_route_trace_index.json','resources/release_health_dashboard.json','resources/live_source_check_matrix.json','resources/source_badges.json','resources/source_trust_tiers.json','resources/human_review_queue.json','resources/source_review_report.json','resources/source_snapshots/latest.json','resources/policy_diff_report.json','resources/official_source_change_log.json','resources/affected_fragments_report.json','paper_templates/extracted_visual_assets/visual_asset_manifest.json']
for rel in required:
