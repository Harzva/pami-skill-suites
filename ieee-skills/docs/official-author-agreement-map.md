# Official Author Agreement and Policy Map

Last curated: 2026-06-11

This document records which official publisher materials the repository uses as design sources. It is not a substitute for live official verification.

## IEEE publisher-wide source hierarchy
...
## Per-journal adapters

Each journal adapter includes:

```text
references/official-links.md
references/author-agreement-notes.md
```

These files list journal homepage, author instructions or guide for authors, submission entry points, and publisher-wide rights/license pages.
