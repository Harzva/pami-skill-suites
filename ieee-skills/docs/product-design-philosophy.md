...
`ieee-skills` is designed to be comparable to a polished academic skill product, not a loose prompt list.

## Product goal

Help researchers draft, revise, audit, and respond to reviews for IEEE Transactions/Journals-style manuscripts while keeping every claim traceable to user-provided evidence, official instructions, or clearly labeled structural examples.
...
2. Official IEEE author-center, policy, template, and style pages.
